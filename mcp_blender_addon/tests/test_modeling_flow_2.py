...
def run() -> int:
    ...
    rec = _call(s, "reference.reconstruct_from_alpha", {"name": "Flow2FromAlpha", "image": img_left, "view": "left", "thickness": 0.15, "threshold": 0.5, "simplify_tol": 2.0, "invert_luma": False})
